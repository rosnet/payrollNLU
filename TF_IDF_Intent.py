...
#        print("\nBest match document = {}".format(best_match))
        with open('payroll_intent_example.json') as f:
            intent = json.load(f)
        try:            
            
            return intent[best_match], highest
...
if __name__ == '__main__':    
    ...
    intent, confidence = x.get_best_match(test)
    print("\nBest match intent = {} \nwith confidence = {}".format(intent, confidence))
